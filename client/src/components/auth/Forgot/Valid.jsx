...
export default function Valid(props) {
    ...
    return (
      <Container>
        <img src='./images/lock2.png' style={{ width: '10em', height: '10em', padding: '1rem' }} alt='' />
        <h4>Checkout Your Mail !</h4>
        <p>Click on below  and type the OTP that you get in your mail {props.data.mail}.</p>
        <TextField
          name="otp"
          variant="outlined"
          type="number"
